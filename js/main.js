...
var wishes = ["Rikka 版权所有","嗯？","这道题超纲了吗，没有超纲！","英雄落泪","我计算机双学位","著名的六加一等于零理论","国考改革对你们钱班影响最大，我对你们最好了","数学（xie）就是这么难","都是你们初中的知识，哪有我高中的","晚自习70%的时间都要学数学，不是学你那个英语","数学（xie）就是螺旋式上升","（集合）只是载体而已","难道你不知道老师出这道题的本质吗","难道你不知道老师出这道题的本质吗","微笑是宏翔的语言，快乐是宏翔的生活，激情是宏翔的动力，卓越是宏翔的追求。身为一名宏翔学生，我在此庄严宣誓:学习是我的天职，报国是我的志向。牢记师长教诲，严守法律校纪。用激情点燃自我，用汗水浇灌学业，用坚韧挑战极限，用自信铸就辉煌。考上大学是去往天堂，宏翔就是我的天路。我坚信我一定能为自己创造奇迹。","课本学一半，高考考什么？考另一半，另一半干嘛，自己推","你们英语那么厚一本维词都背的下来，背几个公式很难吗？","老师安排这道题的本质，就是为了告诉你"];
